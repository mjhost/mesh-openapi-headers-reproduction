curl 'http://localhost:4000/graphql' \
  ...
  -H 'accept: */*' \
  -H 'x-from-request: from-headers-2' \
  ...
  --data-binary $'{"operationName":null,"variables":{"fromVariable":"fromVariable2"},"query":"query ($fromVariable: ID\u0021) {\\n  getThingThingId(thingId: \\"two\\", xFromVariable: $fromVariable) {\\n    result\\n  }\\n}\\n"}' \
  --compressed