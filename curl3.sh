curl 'http://localhost:4000/graphql' \
  ...
  -H 'accept: */*' \
  -H 'x-from-request: from-headers-3' \
  ...
  --data-binary $'{"operationName":null,"variables":{"fromVariable":"fromVariable3","thingId":"three"},"query":"query ($fromVariable: ID\u0021, $thingId: String\u0021) {\\n  getThingThingId(thingId: $thingId, xFromVariable: $fromVariable) {\\n    result\\n  }\\n}\\n"}' \
  --compressed